...
class Multimodal_LLM(nn.Module):
    ...
    def __init__(self, batch_size, config, tokenizer, adapter_llm):
        ...
        self.output_seq_len = min(self.config.audio_seq_len, self.config.video_seq_len)
    ...
    def forward(self, inputs):
        ...
        if self.config.train:
            ...
            outputs = self.adapter_llm.generate(inputs_embeds=text_embeds, max_length=self.config.generate_text_max_len)
